...
def seed_projects():
    ...
    projects = [
        ...
        },
        {
            ...
            "image_filename": "adv-css.png",
            "description": "This directory contains various CSS files added to the Holberton School version 2 curriculum. I completed this project in anticipation of helping newer students overcome any issues that they might encounter while working as a tutor for Holberton.",
            "role": "Front-end developer",
            "repo_link": "https://github.com/ZeroDayPoke/holbertonschool-web_front_end/tree/main/CSS_advanced",
            "skills": ["CSS", "HTML"],
        },
        {
            "name": "HTML Advanced",
            "status": ProjectStatus.COMPLETED,
            "image_filename": "adv-html.png",
            "category": "Front End Web Dev",
            "description": "This directory contains various HTML files and a style guide added to the Holberton School version 2 curriculum. I completed this project in anticipation of helping newer students overcome any issues that they might encounter while working as a tutor for Holberton.",
            "role": "Front-end developer",
            "repo_link": "https://github.com/ZeroDayPoke/holbertonschool-web_front_end/tree/main/html_advanced",
            "skills": ["HTML"],
        },
        {
            "name": "Bootstrap",
            "status": ProjectStatus.COMPLETED,
            "image_filename": "bootstrap.png",
            "category": "Front End Web Dev",
            "description": "This project is dedicated to exploring and implementing Bootstrap, a popular front-end framework. It focuses on using Bootstrap's features such as containers, the grid system, components, and utilities to create responsive and aesthetically pleasing web layouts.",
            "role": "Front-end developer",
            "repo_link": "https://github.com/ZeroDayPoke/holbertonschool-web_front_end/tree/main/Bootstrap",
        ...
        },
        {
            ...
            "status": ProjectStatus.COMPLETED,
            "category": "Front End Web Dev",
            "image_filename": "flex.png",
            "description": "The Flexbox Project is a comprehensive exercise in mastering CSS Flexbox, a powerful layout tool in modern web design. This project focuses on transitioning from traditional CSS layouts to the more dynamic and responsive Flexbox system. It encompasses a range of tasks that gradually build up a deep understanding of Flexbox's capabilities, particularly in creating responsive and adaptable web layouts.",
            "role": "Front-end developer",
            "repo_link": "https://github.com/ZeroDayPoke/holbertonschool-web_front_end/tree/main/flexbox",
            "skills": ["CSS", "HTML"],
        },
        {
            "name": "Accessibility",
            "status": ProjectStatus.COMPLETED,
            "category": "Front End Web Dev",
            "image_filename": "access.png",
            "description": "This project focuses on web accessibility, emphasizing the importance of creating web content that is accessible to all users, including those with disabilities. It covers the implementation of ARIA (Accessible Rich Internet Applications) attributes, understanding WCAG (Web Content Accessibility Guidelines) conformance levels, and the utilization of various tools to ensure web accessibility.",
            "role": "Front-end developer",
            "repo_link": "https://github.com/ZeroDayPoke/holbertonschool-web_front_end/tree/main/accessibility",
            "skills": ["CSS", "HTML"],
        },
        {
            ...
            "status": ProjectStatus.COMPLETED,
            "category": "Front End Web Dev",
            "image_filename": "adv-js.png",
            "description": "This project is focused on advanced JavaScript concepts, including lexical scoping, closures, binding, callbacks, and the execution stack. It demonstrates the practical application of these concepts through a series of JavaScript exercises, each highlighting a specific aspect of advanced JavaScript techniques.",
            "role": "Front-end developer",
            "repo_link": "https://github.com/ZeroDayPoke/holbertonschool-web_front_end/tree/main/Javascript_advanced",
            "skills": ["JavaScript"],
        },
        {
            ...
            "status": ProjectStatus.COMPLETED,
            "category": "Front End Web Dev",
            "image_filename": "devtools.png",
            "description": "This project focuses on understanding and utilizing the various features of Google Chrome DevTools, including the Elements panel, Console, Sources, Network, and more.",
            "role": "Front-end developer",
            "repo_link": "https://github.com/ZeroDayPoke/holbertonschool-web_front_end/tree/main/developer_tools",
            "skills": ["CSS", "HTML"],
        },
        {
            "name": "ES6 Basics",
