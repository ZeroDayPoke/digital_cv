...
def seed_skills():
    skills = [
        ...
        {"name": "Python", "image_filename": "python.png", "level": SkillLevel.INTERMEDIATE,
        ...
        # Frameworks
        {"name": "Flask", "image_filename": "flask.png", "level": SkillLevel.INTERMEDIATE,
        ...
        {"name": ".NET SDK", "image_filename": "dotnet.png",
            "level": SkillLevel.INTERMEDIATE, "category": SkillCategory.FRAMEWORK},
        ...
        # Database
        {"name": "MySQL", "image_filename": "mysql.png", "level": SkillLevel.INTERMEDIATE,
        ...
        # Runtime
        {"name": "Node.js", "image_filename": "node.png", "level": SkillLevel.INTERMEDIATE,
        ...
        {"name": "GCP", "image_filename": "gcp.png",
            "level": SkillLevel.INTERMEDIATE, "category": SkillCategory.DEVOPS},

        # Design Tool
        {"name": "Figma", "image_filename": "figma.png",
            "level": SkillLevel.INTERMEDIATE, "category": SkillCategory.DESIGN_TOOL},
        ...
        {"name": "Linux", "image_filename": "linux.png",
            "level": SkillLevel.INTERMEDIATE, "category": SkillCategory.INFRASTRUCTURE},
