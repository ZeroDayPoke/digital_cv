...
class ProjectAdminView(AdminModelView):
    ...
    """
    column_list = ['name', 'image_filename', 'description', 'related_skills', 'repo_link', 'live_link', 'misc_link', 'misc_name']
    form_columns = ['name', 'image_filename', 'description', 'related_skills', 'repo_link', 'live_link', 'misc_link', 'misc_name']
