...
class Skill(BaseModel):
    ...
    related_projects = db.relationship(
        'Project', secondary=project_skills, back_populates='related_skills')
    related_blogs = db.relationship(
        'Blog', secondary=blog_skills, back_populates='related_skills')
    related_tutorials = db.relationship(
        'Tutorial', secondary=tutorial_skills, back_populates='related_skills')
    related_educations = db.relationship(
        'Education', secondary=education_skills, back_populates='related_skills')
