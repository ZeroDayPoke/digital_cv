...
from ..forms import ProjectForm, UpdateProjectForm, DeleteProjectForm, SkillForm, DeleteSkillForm, BlogForm
...
def interface():
    ...
    add_blog_form.related_skills.choices = [(str(skill.id), skill.name) for skill in Skill.query.all()]
    ...
    return render_template('interface.html', title='Interface', form=form,
                           ...
                           skill_form=skill_form, delete_skill_form=delete_skill_form,
