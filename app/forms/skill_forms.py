...
class BaseSkillForm(FlaskForm):
    ...
    category = SelectField('Skill Category', coerce=str,
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.category.choices = [(category.name, category.value)
...
class AddSkillForm(BaseSkillForm, ImageUploadForm):
    level = SliderField('Skill Level', validators=[
...
class DeleteSkillForm(FlaskForm):
    related_skills = MultiSelectDropdownField(
        'Related Skills', validators=[at_least_one_selection])
...
class SkillForm(ImageUploadForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.level.choices = [(choice.value, choice.name)
                              for choice in SkillLevel]
